...
function atmosphere_scripts_styles() {
	...
	wp_enqueue_style( 'style-front', get_stylesheet_directory_uri() . '/style-front.css', array(), CHILD_THEME_VERSION );
	wp_enqueue_style( 'href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css', array(), CHILD_THEME_VERSION );
...
function sp_custom_footer() { ?>
	<p>Copyright © 2019<p>
	 <!--!Powered by the <a href="http://10.0.0.24/nap/">NMG</a-->
	<!--a href="http://briangardner.com/contact/">Get in Touch</a-->
<?php
}
...
genesis_register_sidebar( array(
	...
	'before_widget' => '<section class="home-news">',
...
genesis_register_sidebar( array(
	'id'          => 'our-service',
	'name'        => __( 'OUR SERVICES', 'atmosphere-pro' ),
	'description' => __( 'OUR SERVICES on the front page.', 'atmosphere-pro' ),
) );
