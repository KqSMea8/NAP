...
function atmosphere_front_page_widgets() {
	...
	genesis_widget_area( 'our-service', array(
		'before' => '<div id="our-service" class="front-page-2"><div class="flexible-widgets widget-area' . atmosphere_widget_area_class( 'front-page-2' ) . '"><div class="wrap">',
		'after'  => '</div></div></div>',
	) );
	...
	genesis_widget_area( 'front-page-4', array(
		'before' => '<div id="front-page-4" class="front-page-4 testimonial"><div class="flexible-widgets widget-area' . atmosphere_widget_area_class( 'front-page-4' ) . '"><div class="wrap">',
		'after'  => '</div></div></div>',
	) );
